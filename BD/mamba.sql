...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2024 a las 00:00:37
...
(1, 'AMIRI tenis MA-1', 'Hombre', 'Blanco/negro, piel de becerro, diseño a paneles, placa del logo, logo en relieve en el lateral', 9, 18120.00, 'item1.png', 0.00, '', ''),
(2, 'Converse tenis Chuck 70 Hi', 'Hombre', 'Tenis Chuck 70 Hi de color rojo de Converse.\nComposición\nSuela: Goma 100%\nExterior: Lona 100%\n', 4, 14460.00, 'item2.png', 1000.00, '', ''),
(3, 'Dolce & Gabbana tenis Portofino', 'Hombre', 'Piel de becerro, parche del logo a un lado, logo en relieve en la parte posterior, puntera redonda', 10, 13890.00, 'item3.png', 2300.00, '', ''),
(4, 'Adidas Forum Low x Bad Bunny', 'Hombre', 'Azul, gamuza, cuero, detalle característico de 3 franjas, puntera redonda, cierre con agujetas', 0, 8876.00, 'item4.png', 0.00, '', ''),
...
(9, 'Dolce & Gabbana tenis bajos', 'Mujer', 'Rosa claro, piel de becerro, diseño a paneles, parche del logo en la lengüeta, cierre con agujetas', 21, 14640.00, 'item9.png', 3000.00, '', ''),
...
(13, 'Alexander McQueen bajos Oversized', 'Mujer', 'Puntera redonda, cierre con agujetas en la parte delantera, detalle de perforaciones', 15, 22212.00, 'item13.png', 0.00, '', ''),
...
--
ALTER TABLE `producto`
  MODIFY `ID_Pto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
